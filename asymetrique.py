...
class AsymWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Chiffrement Asymétrique")
        self.resize(400, 300)
        ...
        header = QLabel("Choisissez un algorithme asymétrique")
        header.setStyleSheet("color: #4A148C; font-size: 18px; font-weight: bold;")
        header.setAlignment(Qt.AlignCenter)
        layout.addWidget(header)

        self.combo = QComboBox()
        self.combo.addItems(["RSA","Diffie-Hellman", "ECC"])
